...
import cassieAf from '../images/cassieattack.gif'
...
export default function GameProvider(props){
    ...
    const [enemies, setEnemies] = useState([{ name: 'CAPTAIN CASSIE', health: 150, item: 'the HIDDEN YouTube dislike button', min: 25, max: 35, _id: 0, facing_sprite: cassieF, walking_sprite: cassieW, attacking_sprite: cassieA  } , { name: "JACOB 'THE PEACEKEEPER'", health: 150, item: 'order 66', min: 38, max: 42, _id: 1 , facing_sprite: jacobF, walking_sprite: jacobW, attacking_sprite: jacobA} , { name: 'Ty Rex', health: 150, item: 'Unbreakable Will', min: 25, max: 35, _id: 2 , facing_sprite: tyrexF, walking_sprite: tyrexW, attacking_sprite: tyrexA } , { name: 'CAPTAIN CASSIE FADE', health: 280, item: "Snow White's Apple", min: 30, max: 50 , _id: 3 , facing_sprite: cassieFf, walking_sprite: cassieWf, attacking_sprite: cassieAf } , { name: "JACOB 'THE PEACEKEEPER' FADE", health: 280, item: "Thanos' Gauntlet Snap", min: 50, max: 65, _id: 4  , facing_sprite: jacobFf, walking_sprite: jacobWf, attacking_sprite: jacobAf} , { name: 'Ty Rex FADE', health: 300, item: 'Breakable Will', min: 35, max: 50, _id: 5 , facing_sprite: tyrexFf, walking_sprite: tyrexWf, attacking_sprite: tyrexAf }])
